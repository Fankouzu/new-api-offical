...
func EpayNotify(c *gin.Context) {
	...
	if verifyInfo.TradeStatus == epay.StatusTradeSuccess {
		...
		if topUp.Status == common.TopUpStatusPending {
			...
			trackGA4TopUpSuccess(c, verifyInfo.ServiceTradeNo)
		} else {
			retryFailedGA4TopUpDeliveryIfCompleted(c, verifyInfo.ServiceTradeNo, model.PaymentProviderEpay, "")
		}
	} else {
...
func AdminCompleteTopUp(c *gin.Context) {
	...
	trackGA4TopUpSuccess(c, req.TradeNo)
