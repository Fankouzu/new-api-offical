...
|比例 | 清晰度|  尺寸 | 低品质 (low) | 中等品质 (medium) | 高品质 (high) |
|---|---|---|---|---|---|
| 4:3  | 1K | 1024×768 | 0.8333× = **¥0.04** | 6.1667× = **¥0.26** | 24.1667× = **¥1.02** |
|      | 2K | 2048x1536 |   |   |   |
|      | 4K | 3840x2880 |   |   |   |
| 1:1  | 1K | 1024×1024 | 1.0000× = **¥0.04** | 8.8333× = **¥0.37** | 35.1667× = **¥1.48** |
|      | 2K | 2048x2048 |   |   |   |
|      | 4K | 2880x2880 |   |   |   |
| 2:3  | 1K | 1024×1536 | 0.8333× = **¥0.04** | 7.0000× = **¥0.29** | 27.5000× = **¥1.16** |
|      | 2K | 2048x3840 |   |   |   |
|      | 4K | 2560x3840 |   |   |   |
| 16:9 | 1K | 1920×1080 | 0.8333× = **¥0.04** | 6.6667× = **¥0.28** | 26.3333× = **¥1.11** |
| 16:9 | 2K | 2560×1440 | 1.1667× = **¥0.05** | 9.3333× = **¥0.39** | 37.0000× = **¥1.55** |
| 16:9 | 4K | 3840×2160 | 2.0000× = **¥0.08** | 16.8333× = **¥0.71** | 66.8333× = **¥2.81** |

---

## 图生图 (i2i) 价格表

- 生成图像的尺寸。支持预设名称或自定义 {宽度，高度}。宽高两个数值均必须为 16 的倍数，最大边长 3840 像素，长宽比不超过 3:1，总像素范围在 655360 至 8294400 之间

|比例 | 清晰度|  尺寸 | 低品质 (low) | 中等品质 (medium) | 高品质 (high) |
|---|---|---|---|---|---|
| 4:3  | 1K | 1024×768  | 1.8333× = **¥0.08** | 7.1667× = **¥0.30** | 25.1667× = **¥1.06** |
|      | 2K | 2048x1536 |   |   |   |
|      | 4K | 3840x2880 |   |   |   |
| 1:1  | 1K | 1024×1024 | 2.5000× = **¥0.11** | 10.1667× = **¥0.43** | 36.5000× = **¥1.53** |
|      | 2K | 2048x2048 |   |   |   |
|      | 4K | 2880x2880 |   |   |   |
| 2:3  | 1K | 1024×1536 | 3.0000× = **¥0.13** | 9.0000× = **¥0.38** | 29.6667× = **¥1.25** |
|      | 2K | 2048x3840 |   |   |   |
|      | 4K | 2560x3840 |   |   |   |
| 16:9 | 1K | 1920×1080 | 2.8333× = **¥0.12** | 8.8333× = **¥0.37** | 26.3333× = **¥1.11** |
| 16:9 | 2K | 2560×1440 | 3.1667× = **¥0.13** | 11.3333× = **¥0.48** | 39.0000× = **¥1.64** |
| 16:9 | 4K | 3840×2160 | 4.0000× = **¥0.17** | 18.8333× = **¥0.79** | 68.8333× = **¥2.89** |
